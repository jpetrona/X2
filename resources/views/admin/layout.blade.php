...
<head>
  ...
  <link href="https://cdnjs.cloudflare.com/ajax/libs/jquery.scrollbar/0.2.11/jquery.scrollbar.min.css" rel="stylesheet" type="text/css"/>
  @yield('css')
  ...
  <div class="page-sidebar" id="main-menu"> 
    ...
    <ul>	
      ...
      <li class=""> <a href="javascript:;"> <i class="fa fa-area-chart"></i> <span class="title">Reports</span> <span class="arrow "></span> </a>
        <ul class="sub-menu">
        <li > <a href="typography.html"><i class="fa fa-bar-chart" aria-hidden="true"></i> Offers </a> </li>
          <li > <a href="messages_notifications.html"><i class="fa fa-area-chart" aria-hidden="true"></i> Leads </a> </li>
          <li > <a href="icons.html"><i class="fa fa-pie-chart" aria-hidden="true"></i> OfferWall</a> </li>
          <li > <a href="buttons.html"><i class="fa fa-user" aria-hidden="true"></i> Members</a> </li>		 
        </ul>
      </li>
